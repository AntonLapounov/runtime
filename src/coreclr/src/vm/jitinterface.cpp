    ...
    case IMAGE_REL_ARM64_PAGEBASE_REL21:
        {
            ...
            INT64 locationPage = (INT64)location & ~0xFFFLL;
            INT64 relPage = ((INT64)target - locationPage) >> 12;
            _ASSERTE(FitsInRel21(relPage));
            PutArm64Rel21((UINT32 *)location, (INT32)relPage);
        }
        break;
